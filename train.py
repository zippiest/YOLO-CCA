...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/training/yolov7-zpd.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/2021.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='v7cca_2021', help='save to project/name')
